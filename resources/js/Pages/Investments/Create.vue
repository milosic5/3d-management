  ...
  <AppLayout>
    <template #breadcrumb>
        <div class="flex items-center space-x-2">
            ...
            <span class="text-slate-800 dark:text-slate-200 font-medium">{{ $t('investments.new') }}</span>
        </div>
    </template>
    
    <PageHeader :title="$t('investments.new')" description="" />
