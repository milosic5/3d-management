  ...
  <AppLayout>
    <template #breadcrumb>
        <div class="flex items-center space-x-2">
            ...
            <span class="text-slate-800 dark:text-slate-200 font-medium">{{ $t('users.new') }}</span>
        </div>
    </template>
    
    <PageHeader :title="$t('users.new')" description="" />
      ...
      <Card class="p-6 space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <Input type="password" v-model="form.password" required class="w-full" />
